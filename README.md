...
Бот управляет конфигами, созданными установщиком [Nyr/openvpn-install](https://github.com/Nyr/openvpn-install), через Telegram. Пользователь видит свои конфиги, срок действия, может повторно получить файл или отправить заявку на новый. Администратор обрабатывает заявки либо ищет пользователей по username/Telegram ID, выдаёт конфиги, меняет сроки и отзывает доступ.
