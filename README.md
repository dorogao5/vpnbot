...
- Пользователь сам отправляет заявку на новый конфиг; администратор получает уведомление, выбирает срок и конкретный готовый сервер, после чего бот создаёт и сразу отправляет `.ovpn`.
